...
if __name__ == "__main__":
    ...
    @hydra.main(config_path='E:\workspace\AX2CT/newview_diffusion\config', config_name='base_cfg', version_base=None)
    def run(cfg: DictConfig):

        model = VQGAN(cfg).cuda()
...
# encoder: 1,1,128,128,128--1,64,32,32,32      35.534G 441.056K
# pre_vq_conv: 1,64,32,32,32--1,8,32,32,32     16.777M 520.000B
# codebook:1,8,32,32,32 --1,8,32,32,32   0,0
# post_vq_conv: 1,8,32,32,32 -- 1,64,32,32,32   16.777M 576.000B
#  decoder: 1,64,32,32,32 -- 1,1,128,128,128   693.302G 947.521K